...
def make_scatter(df, macro_mid, asset_mid):
    ...
    fig.update_layout(
        ...
        legend=dict(orientation="h", yanchor="bottom", y=1.01, font=dict(size=11, color="white"), xanchor="right", x=1, font=dict(size=11, color="white")),
...
def make_us_map(df, metric="combined"):
    ...
    fig.update_layout(
        ...
        legend=dict(orientation="h", yanchor="bottom", y=1.01, font=dict(size=11, color="white"),
